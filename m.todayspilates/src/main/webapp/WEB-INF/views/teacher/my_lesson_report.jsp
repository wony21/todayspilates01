          	...
          	<div id="date-container">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3">
		            <div class="btn-toolbar mb-2 mb-md-0">
						...
						<select class="custom-select" id="report-year" style="width: 80px; margin-left: 5px;"></select>
		                </div>
		                <div class="input-group">
						<select class="custom-select" id="report-month" style="width: 60px; margin-left: 5px;"></select>
		                </div>
		                <div class="input-group">
