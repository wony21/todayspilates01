  ...
  <body id="page-top">
    ...
    <header class="masthead d-flex">
      <div class="container text-center">
        <h2 class="mb-4">Todays Pilates</h2>
        <a href="#" class="btn btn-xl btn-light mr-4">실적</a>
        <a href="#" class="btn btn-xl btn-dark">bb</a>
        <h2 class="mb-4">&nbsp;</h2>
        <a href="#" class="btn btn-xl btn-light mr-4">cc</a>
        <a href="#" class="btn btn-xl btn-dark">cc</a>
      </div>
    </header>
